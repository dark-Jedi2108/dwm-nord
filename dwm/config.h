...
static const char *tags[] = { "cmd", "www", "dev", "sys", "chat", "med" };
static const char *alttags[] = { "[cmd]", "[www]", "[dev]", "[sys]", "[chat]", "[med]" };
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", "#81a1c1", "-sf", col_gray4, "-l", "20", NULL };
